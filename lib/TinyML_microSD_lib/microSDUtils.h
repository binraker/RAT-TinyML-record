...
void saveLongSensorData(int sensorAxes, int dataSavePeriodInSeconds, int currentFile, String currentFile_timestamp, uint32_t tankAddress, uint32_t tankSize);
